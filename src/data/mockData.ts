...
export const invoices: Invoice[] = [
  {
    id: "inv1", invoiceNumber: "INV-2024-001", clientId: "c1", clientName: "Alice Johnson",
    date: "2024-01-15", dueDate: "2024-02-15",
    items: [{ productId: "p1", productName: "Wireless Keyboard", quantity: 2, unitPrice: 89.99 }],
    amount: 179.98, status: "Paid",
  },
  {
    id: "inv2", invoiceNumber: "INV-2024-002", clientId: "c4", clientName: "David Kim",
    date: "2024-01-20", dueDate: "2024-02-20",
    items: [
  ...
  {
    id: "inv3", invoiceNumber: "INV-2024-003", clientId: "c2", clientName: "Bob Martinez",
    date: "2023-12-01", dueDate: "2024-01-01",
    items: [{ productId: "p2", productName: "USB-C Hub (7-in-1)", quantity: 5, unitPrice: 49.99 }],
    amount: 249.95, status: "Overdue",
  },
  {
    id: "inv4", invoiceNumber: "INV-2024-004", clientId: "c5", clientName: "Eva Rossi",
    date: "2024-02-01", dueDate: "2024-03-01",
    items: [{ productId: "p8", productName: "Cable Management Kit", quantity: 10, unitPrice: 22.00 }],
    amount: 220.00, status: "Draft",
  },
  {
    id: "inv5", invoiceNumber: "INV-2024-005", clientId: "c1", clientName: "Alice Johnson",
    date: "2024-02-10", dueDate: "2024-03-10",
...
export const recentActivity = [
  { id: 1, action: "Invoice Created", detail: "INV-2024-005 for Alice Johnson", time: "2 hours ago", type: "invoice" },
  ...
  { id: 4, action: "Payment Received", detail: "INV-2024-001 · $179.98", time: "Yesterday", type: "payment" },
  { id: 5, action: "Invoice Overdue", detail: "INV-2024-003 · Bob Martinez", time: "Jan 1", type: "overdue" },
];
