...
const invoices = [
    {
        id: "inv1", invoiceNumber: "INV-2024-001", clientId: "c1",
        dueDate: "2024-02-15",
        items: [{ productId: "p1", quantity: 2, price: 89.99 }],
        total: 179.98, status: "paid",
    },
    {
        id: "inv2", invoiceNumber: "INV-2024-002", clientId: "c4",
        dueDate: "2024-02-20",
        items: [
    ...
    {
        id: "inv3", invoiceNumber: "INV-2024-003", clientId: "c2",
        dueDate: "2024-01-01",
        items: [{ productId: "p2", quantity: 5, price: 49.99 }],
        total: 249.95, status: "overdue",
    },
    {
        id: "inv4", invoiceNumber: "INV-2024-004", clientId: "c5",
        dueDate: "2024-03-01",
        items: [{ productId: "p8", quantity: 10, price: 22.00 }],
        total: 220.00, status: "draft",
    },
    {
        id: "inv5", invoiceNumber: "INV-2024-005", clientId: "c1",
        dueDate: "2024-03-10",
